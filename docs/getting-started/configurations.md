...
'assets_path' => '/vendor/tuyck/voyager/assets',
```
...
{% hint style="info" %}
When upgrading to new version of voyager the assets located in the `/vendor/tuyck/voyager/assets` directory may need to be overwritten, so if you wish to customize any styles you will want to duplicate that directory and specify the new location of your asset\_path.
{% endhint %}
...
'dashboard' => [
    ...
    'widgets' => [
        'Tuyck\\Voyager\\Widgets\\UserDimmer',
        'Tuyck\\Voyager\\Widgets\\PostDimmer',
        'Tuyck\\Voyager\\Widgets\\PageDimmer',
    ],
],
```
...
**widgets** Here you can manage the widgets that live on your dashboard. You can take a look at an example widget class by viewing the current widgets inside of `tuyck/voyager/src/Widgets`.
