...
class ControllersCommand extends Command
{
    ...
    {
        $stub = $this->getStub();
        $files = $this->filesystem->files(base_path('vendor/Tuyck/voyager/src/Http/Controllers'));
        $namespace = config('voyager.controllers.namespace', 'Tuyck\\Voyager\\Http\\Controllers');
    ...
    {
        return $this->filesystem->get(base_path('/vendor/Tuyck/voyager/stubs/'.$this->stub));
    }
    ...
    protected function generateContent($stub, $class)
    {
        ...
        $content = str_replace(
            'FullBaseDummyClass',
            'Tuyck\\Voyager\\Http\\Controllers\\'.$class,
            $content
        );
